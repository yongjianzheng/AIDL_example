...
import com.yongjian.aidl_example.IRemote;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    void initConnection(){
        ...
        if(mService == null)
        {
            ...
            it.setComponent(new ComponentName("com.yongjian.aidl_example","com.yongjian.aidl_example.ArithmeticService"));
        ...
        switch(v.getId()){
            case R.id.add:{
                ...
                try{
                    ...
                    mResultText.setText("Result -> Add ->"+res);
